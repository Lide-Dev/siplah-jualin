                    ...
                    <table class="table table-bordered table-striped" role="grid">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th><?php echo trans('user'); ?> / Nama Toko</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($products as $item) : ?>
                                <tr>
                                    ...
                                    <td><?php if ($item->type_product_name == "Buku") echo $item->type_product_name . " - " . ($item->catalog_type == "text_book" ? "Text Book" : "Non Text Book");
                                        else echo $item->type_product_name ?></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        if (!empty($user)) : ?>
                                            <a href="<?php echo generate_profile_url($user->slug); ?>" target="_blank" class="table-username">
                                                <?php echo html_escape($user->username)."/".$item->shop_name; ?>
                                            </a>
                                        <?php endif; ?>
                                    </td>
