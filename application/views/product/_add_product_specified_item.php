    ...
    <div class="form-box">
        ...
        <div class="form-box-body">
            ...
            <?php else : ?>
                <div class="row">
                    <div class="form-group col-6">
                        <label class="control-label">Harga Zona 1</label>
                        <input type="number" name="price_1" class="form-control form-input" placeholder="Harga Zona 1" value="<?= empty(set_value("price_1")) ? $book->prices_json[0]->price : set_value("price_1") ?>" required min="1">
                        <?php echo form_error('price_1'); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6">
                        <label class="control-label">Harga Zona 2</label>
                        <input type="number" name="price_2" class="form-control form-input" placeholder="Harga Zona 2" value="<?= empty(set_value("price_2")) ? $book->prices_json[1]->price : set_value("price_2") ?>" required min="1">
                        <?php echo form_error('price_2'); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6">
                        <label class="control-label">Harga Zona 3</label>
                        <input type="number" name="price_3" class="form-control form-input" placeholder="Harga Zona 3" value="<?= empty(set_value("price_3")) ? $book->prices_json[2]->price : set_value("price_3") ?>" required min="1">
                        <?php echo form_error('price_3'); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6">
                        <label class="control-label">Harga Zona 4</label>
                        <input type="number" name="price_4" class="form-control form-input" placeholder="Harga Zona 4" value="<?= empty(set_value("price_4")) ? $book->prices_json[3]->price : set_value("price_4") ?>" required min="1">
                        <?php echo form_error('price_4'); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6">
                        <label class="control-label">Harga Zona 5</label>
                        <input type="number" name="price_5" class="form-control form-input" placeholder="Harga Zona 5" value="<?= empty(set_value("price_5")) ? $book->prices_json[4]->price : set_value("price_5") ?>" required min="1">
                        <?php echo form_error('price_5'); ?>
                    </div>
                </div>
            <?php endif; ?>
