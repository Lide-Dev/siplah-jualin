...
class Settings_model extends CI_Model
{
    ...
    public function update_midtrans_settings()
    {
        $data = array(
            'midtrans_enabled' => $this->input->post('midtrans_enabled', true),
            'midtrans_mode' => $this->input->post('midtrans_mode', true),
            'midtrans_merchant_id' => trim($this->input->post('midtrans_merchant_id', true)),
            'midtrans_client_id' => trim($this->input->post('midtrans_client_id', true)),
            'midtrans_secret_key' => trim($this->input->post('midtrans_secret_key', true))
        );
        $this->db->where('id', 1);
        return $this->db->update('payment_settings', $data);
    }
